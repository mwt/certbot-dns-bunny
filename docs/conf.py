# -*- coding: utf-8 -*-
#
# certbot-dns-bunny documentation build configuration file, created by
...
htmlhelp_basename = 'certbot-dns-bunnydoc'
...
man_pages = [
    (master_doc, 'certbot-dns-bunny', u'certbot-dns-bunny Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'certbot-dns-bunny', u'certbot-dns-bunny Documentation',
     author, 'certbot-dns-bunny', 'One line description of project.',
     'Miscellaneous'),
]
